...
def convnext_tiny(opt, in_22k=True, **kwargs):
    ...
    if pretrained == 'imagenet':
        ...
        if opt.input_type == 'flow':
            state_dict = torch.load("/NAS/xiaohang/checkpoints/9_convnext_tiny_miex_flow_240614_154340.pth", map_location=opt.device)
