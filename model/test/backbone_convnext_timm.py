...
from model.test import ema_attention
from model.test import DWT
from model.test import CBAM
...
class ConvNeXtStage(nn.Module):
    ...
    def __init__(
        ...
        self.ema1 = ema_attention.EMA(channels=96, factor=8)
        self.ema2 = ema_attention.EMA(channels=192, factor=16)
        self.ema3 = ema_attention.EMA(channels=384, factor=32)
        self.ema4 = ema_attention.EMA(channels=768, factor=64)
    ...
    def forward(self, x):
        ...
        if channels == 96:
            ...
            raise ValueError("channels must in [96, 192, 384, 768]")
...
class ConvNeXt(nn.Module):
    ...
    def __init__(
        ...
        # self.ema = ema_attention.EMA(channels=768, factor=32)
